 ...
 */
public class Page2Y implements Handler {

    // URL of this page relative to http://localhost:7001/
    public static final String URL = "2Y";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + """
            <div class='content'>
                <p>Hello, the creators of this website are Ayan Panghal (s4164439) and Pasquale Pedulla (s4245753).</p>
            </div>
            """;
