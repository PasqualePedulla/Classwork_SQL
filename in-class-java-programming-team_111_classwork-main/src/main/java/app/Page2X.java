 ...
 */
public class Page2X implements Handler {

    // URL of this page relative to http://localhost:7001/
    public static final String URL = "2X";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + """
            <div class='header'>
                <h1>
                    ...
                    OKAY I THINK IT WORKS NOW??? :/ 112123
                </h1>
            </div>
        """;
        ...
        html = html + """
            <div class='content'>
                <p>Use this HTML file to create your movie website's homepage.</p>
            </div>
            """;
