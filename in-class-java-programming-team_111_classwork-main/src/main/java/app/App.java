...
public class App {
    ...
    public static void configureRoutes(Javalin app) {
        ...
        // Programming Class 2 Pages
        app.get(PageIndex.URL, new PageIndex());
        app.get(Page2X.URL, new Page2X());
        app.get(Page2Y.URL, new Page2Y());

        // Programming Class 3 Pages
        app.get(PageMoviesList.URL, new PageMoviesList());      
        app.get(Page3X.URL, new Page3X());
        app.get(Page3Y.URL, new Page3Y());

        // Programming Class 4 Pages
        app.get(PageMoviesType.URL, new PageMoviesType());
        app.get(Page4X.URL, new Page4X());
        app.get(Page4Y.URL, new Page4Y());


        // POST pages can accept form data
        // So, make sure to add your Programming Class 4 post method calls here
