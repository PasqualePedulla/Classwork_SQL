 ...
 */
public class Page3X implements Handler {

    // URL of this page relative to http://localhost:7001/
    public static final String URL = "3X";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + """
            <div class='content'>
                <p>Use your combined Java, HTML and SQL skills to show the list of all movie directors.</p>
